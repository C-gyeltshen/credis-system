...
export default function CreditGivenModal() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setSnackbarMessage(`✅ Credit of Nu. ${amount} issued successfully to ${customerName || "customer"}!`);
        ...
        >
          ...
          <View style={[styles.header, { backgroundColor: CONFIG.color }]}>
            <IconButton
              ...
              iconColor="#fff"
            />
            <Text style={styles.headerTitle}>Issue Credit</Text>
            <View style={{ width: 40 }} />
          </View>
