...
export const createCreditSchema = z
  .object({
    ...
    transaction_type: z.enum(["credit_given", "payment_received"], {
      message:
        "Transaction type must be either credit_given or payment_received",
    }),
    items_description: z
      .string()
...
export type CreditTransactionFiltersSchema = z.infer<
  typeof creditTransactionFiltersSchema
>;
export type CreditIdParamSchema = z.infer<typeof creditIdParamSchema>;
