...
export class CustomerBalanceRepository {
    async upsertBalance({ customerId, storeId, totalCreditGiven, totalPaymentsReceived, outstandingBalance, lastCreditDate, lastPaymentDate, lastTransactionDate, }) {
    ...
    async findCustomersWithOverduePayments(days, storeId) {
