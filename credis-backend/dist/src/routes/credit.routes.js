...
import { createCreditSchema, updateCreditSchema, } from "../validators/credit.validator.js";
...
creditRoutes.patch("/:id", validate(updateCreditSchema), controller.updateCredit);
...
creditRoutes.get("/customer/:customerId/summary", controller.getCustomerSummary);
...
creditRoutes.get("/store/:storeId/outstanding", controller.getCustomersWithOutstandingBalance);
